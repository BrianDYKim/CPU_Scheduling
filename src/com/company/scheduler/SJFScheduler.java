...
public class SJFScheduler {
    ...
    /** Constructor*/
    public SJFScheduler() {
        MyProcess dispatchedProcess; // CPU에 dispatch된 프로세스
        processSort(); // burst time 기준으로 프로세스를 정렬하고 시작함.
        ...
        // 테이블 갱신
        tableModel.insertRow(readyQueue.getSize(), new Object[]{"total(SJF)", "", "", "",
    ...
    /** Burst time 기준으로 프로세스를 정렬하는 메소드입니다.*/
    public void processSort() {
        ...
        for(int i = 0; i < readyQueue.getSize() - 1; i++) {
            ...
            for(int j = i + 1; j < readyQueue.getSize(); j++) {
                ...
                if(comp1.getBurstTime() > comp2.getBurstTime())
                    min = j;
            }
